...
2. if len(arr) >2 find the mid for partitioning which is half of the length of the array
3. call mergesort on the left of the mid and  the right of the mid-point of the partition
4. the merge and the sort algorithm goes like the following
